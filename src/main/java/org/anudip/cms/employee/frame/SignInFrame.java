            ...
            public void actionPerformed(ActionEvent actionevent) {
                ...
                try {
                    ...
                    if (employee != null) {
                        ...
                        OpenEmployeeDashboard dashboard = new OpenEmployeeDashboard();
                        dashboard.openEmployeeDashboard(employee.getFirstName(), employee.getLastName());
                    } else {
                        // Show an error message
                        JOptionPane.showMessageDialog(null, "SignIn failed. Try Again");
                    }
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
